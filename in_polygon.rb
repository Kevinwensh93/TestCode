def is_point_in_polygon(point, vertices)
  ...
  for i in (0..vertices.length - 1) do
    ...
    return true if (vy2 - vy1).to_f / (vx2 - vx1).to_f  == ( y - vy1 ).to_f / ( x - vx1).to_f
    ...
    x_intersection = (y - vy1) * (vx2 - vx1) / (vy2 - vy1) + vx1 # finds full horizontal line intersection x value
